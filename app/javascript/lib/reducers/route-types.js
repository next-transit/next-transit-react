...
export default createReducer({
  ...
  [types.route_types.ROUTE_TYPES_REQUESTED]: routeTypesRequested,
  [types.route_types.ROUTE_TYPES_RECEIVED]: route_types_received,
  [types.route_types.ROUTES_RECEIVED]: routes_received
});
